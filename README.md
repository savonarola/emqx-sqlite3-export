...
However, SQLite is a great choice for many applications with moderate load. Since the database is a single file, it may be easily backed up, exported, and analyzed.
...
![EMQX Webhook New](images/webhook-new.png)
